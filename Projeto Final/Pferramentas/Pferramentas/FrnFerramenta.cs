...
{
    public partial class FrnFerramenta : Form
    {
        ...
        public FrnFerramenta()
        {
            InitializeComponent();
        }

        private void FrnFerramenta_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                bnbFerramenta.BindingSource = bnFerramenta;
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                RegFerr.Distribuicao = Convert.ToChar(cbxDistribuicao.SelectedValue);
